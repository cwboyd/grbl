...
// VARIABLE_SPINDLE will not work for some pre-built Uno shields (namely the Protoneer board) which use
// Uno D11 as the Z limit and D12 as the spindle enable.
